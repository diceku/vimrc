...
nnoremap <silent> <F2> :<C-u>e ~/.config/vim/dein.toml<CR>
...
noremap <silent> <space>g  :<C-u>Denite grep:. -no-empty<CR>
...
noremap <silent> ;m  :<C-u>Denite file_mru<CR>
...
nnoremap <leader>lrename :LspRename<cr>
nnoremap <leader>lstatus :LspStatus<cr>

" Flutter
let dart_format_on_save = 0
nnoremap <leader>df :DartFmt<cr>
nnoremap <leader>fap :FlutterRun -t lib/main_player_develop.dart --flavor playerdevelop
nnoremap <leader>fas :FlutterRun -t lib/main_shop_develop.dart --flavor shopdevelop
...
nnoremap <leader>fE :FlutterEmulatorsLaunch
